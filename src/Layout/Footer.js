...
import API from "../API";
import { de, s3 } from "../utils/Helper";
    ...
    return (
        <>
            ...
            >
                            ...
                            <div className="slider">
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        >
                                            <img
                                                src={s3 + "/Images1/h&tecnicaleducation.png"}
                                                alt="h&t"
                                            />
                                        </a>
                                    </div>
                                    <div>
                                        <a
                                            ...
                                            rel="noreferrer"
                                        >
                                            <img src={s3 + "/Images1/carousal.png"} alt="dte" />
                                        </a>
                                    </div>
                                    <div>
                                        <a
                                            ...
                                            rel="noreferrer"
                                        >
                                            <img src={s3 + "/Images1/image.png"} alt="mhrd" />
                                        </a>
                                    </div>
                                    <div>
                                        <a
                                            ...
                                            rel="noreferrer"
                                        >
                                            <img src={s3 + "/Images1/email.jpg"} alt="google" />
                                        </a>
                                    </div>
                                    <div>
                                        <a
                                            ...
                                            rel="noreferrer"
                                        >
                                            <img src={s3 + "/Images1/aicte.png"} alt="aicte" />
                                        </a>
                                    </div>
                                    <div>
                                        <a
                                            ...
                                            rel="noreferrer"
                                        >
                                            <img src={s3 + "/Images1/COA.jpeg"} alt="COA" />
                                        </a>
                                    </div>
                                    <div>
                                        <a
                                            ...
                                            rel="noreferrer"
                                        >
                                            <img src={s3 + "/Images1/PCI.png"} alt="PCI" />
                                        </a>
                                    </div>
                                    ...
                                    <div>
                                        <a
                                            ...
                                            rel="noreferrer"
                                        >
                                            <img src={s3 + "/Images1/webdirectory.png"} alt="goi" />
                                        </a>
                                    </div>
                                    <div>
                                        <a
                                            ...
                                            rel="noreferrer"
                                        >
                                            <img src={s3 + "/Images1/boat.png"} alt="apprentice" />
                                        </a>
                                    </div>
                                    <div>
                                        <a
                                        ...
                                        >
                                            <img
                                                src={s3 + "/Images1/scholership.png"}
                                                alt="mahaeschol"
                                            />
                                        </a>
                                    </div>
                                    <div>
                                        <a
                                            ...
                                            rel="noreferrer"
                                        >
                                            <img src={s3 + "/Images1/Nptel.png"} alt="nptel" />
                                        </a>
                                    </div>
                                    <div>
                                        <a
                                        ...
                                        >
                                            <img
                                                src={s3 + "/Images1/springboard.png"}
                                                alt="springboard"
                                            />
                                        </a>
                                    </div>
                                    <div>
                                        <a
                                            ...
                                            rel="noreferrer"
                                        >
                                            <img src={s3 + "/Images1/virtuallab.png"} alt="vlab" />
                                        </a>
                                    </div>
                                    <div>
                                        <a
                                            ...
                                            rel="noreferrer"
                                        >
                                            <img src={s3 + "/Images1/swayam.png"} alt="swayam" />
                                        </a>
                                    </div>
                                </Carousel>
                            </div>
                ...
                <div className="container-fluid footerContainerwidth">
                    <div className="row">
                        <ul className="">
                            ...
                            <li>
                                <Link onClick={scrollToTop} to="/institute">
                                    Institutes
                                </Link>
                            </li>
                            <li>
                                <Link onClick={scrollToTop} to="/admission">
                                    Admission
                                </Link>
                            </li>
                            <li>
                                <Link onClick={scrollToTop} to="/examination">
                                    Examination
                                </Link>
                            </li>
                            <li>
                            ...
                            <li>
                                <Link onClick={scrollToTop} to="/sitemap">
                                    Sitemap
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div className="footerLinks marginDiv py-1 my-2">
                        ...
                        <a href="#" title="Valid XHTML 1.0 Transitional">
                            <img
                                src={s3 + "/Images1/valid-xhtml.png"}
              ...
              <img
                src={s3+"/Images1/india-gov-in.jpg"
...
function GetVisitor(setMsg, setShow, setVisitor) {
    API.get("visitor/count")
        .then((res) => {
            if (res.data.status === "success") {
                setVisitor(JSON.parse(de(res.data.data)));
            }
        })
        .catch((error) => {
            setShow(true);
...
function getLastUpdateDate(setMsg, setShow, setLastUpdatedDate) {
    API.get("lastUpdateDate")
        .then((res) => {
            if (res.data.status === "success") {
                setLastUpdatedDate(JSON.parse(de(res.data.data)));
            }
        })
        .catch((error) => {
            setShow(true);
